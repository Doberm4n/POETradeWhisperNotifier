...
- python whisperNotify.py -t "pushbullet API token" (without quotes) -p "full path to Client.txt file" (with quotes) -s <path to sound file (.wav, .mp3) (optional) (with quotes) 
>or
